...
export function AiChat() {
  const [messages, setMessages] = useState([
    { id: 1, text: "Hello! I'm your AI language tutor. How can I help you today?", sender: 'ai' }
  ])
  ...
  const getAIResponse = userInput => {
    const responses = [
      "That's a great question! Let's explore it further.",
      "Interesting point! Here's a tip to help you improve: practice makes perfect!",
      "Well done! You're making excellent progress in your language learning journey.",
      "I see you're curious about that. Let me explain it in more detail.",
      "That's a common mistake, but don't worry! Here's how you can correct it.",
    ]
  ...
  return (
    (<div
      className="min-h-screen bg-black text-green-500 font-pixel p-4 relative overflow-hidden">
      <style jsx global>{`
        @font-face {
          ...
          <CardContent className="p-4 chat-container h-[60vh] overflow-y-auto">
            ...
            {isTyping && (
              <motion.div
                ...
                <div
                  className="bg-gray-800 text-green-400 px-4 py-2 rounded-none border-2 border-green-500">
                  <motion.span
